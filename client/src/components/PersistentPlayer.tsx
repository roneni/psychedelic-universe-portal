...
import { Play, Pause, Volume2, VolumeX, SkipForward, SkipBack, Radio } from "lucide-react";
...
export function PersistentPlayer() {
  ...
  const currentTrack = {
    title: "Astral Projection - Mahadeva (Original Mix)",
    artist: "Psychedelic Universe Radio",
        ...
        <div className="container flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 w-1/3">
            <div className={cn(
              ...
              <img src={currentTrack.cover} alt="Cover" className="w-full h-full object-contain bg-black" />
              {isPlaying && (
            ...
            <div className="hidden md:block overflow-hidden">
              ...
              <p className="text-primary text-sm truncate flex items-center gap-2">
          ...
          <div className="flex flex-col items-center gap-2 w-1/3">
            ...
            {/* Progress Bar (Visual Only for Radio) */}
